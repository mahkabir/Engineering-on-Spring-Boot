...
public class DesignationResource {
    ...
    public ApiResponse<CompanyDetailsResponse> saveDesignation(@Valid @RequestBody CompanyDetailsRequest companyDetailsRequest) {
        final CompanyDetailsResponse response = iDesignationManagementService.saveDesignationDetails(companyDetailsRequest);
        return ResponseUtils.createResponseObject((ResponseMessage.OPERATION_SUCCESSFUL), response);
    }

    @PostMapping("/edit-designation")
    public ApiResponse<CompanyDetailsResponse> editDesignation(@Valid @RequestBody CompanyDetailsRequest companyDetailsRequest) {
        final CompanyDetailsResponse response = iDesignationManagementService.editDesignationDetails(companyDetailsRequest);
        return ResponseUtils.createResponseObject((ResponseMessage.OPERATION_SUCCESSFUL), response);
    }
